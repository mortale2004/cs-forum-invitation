const wrapper = document.getElementsByClassName("hideWrapper")[0];
const preLoader = document.createElement("div");


document.addEventListener("DOMContentLoaded", ()=>{
  preLoader.classList.add("preLoader");
  preLoader.innerText = "👆Click to open surprise💐";
  wrapper.insertAdjacentElement("beforebegin", preLoader);
})
document.addEventListener("click", ()=>{
  setTimeout(()=>{
    preLoader.innerHTML = "1";
  }, 1000)
  setTimeout(()=>{
    preLoader.innerHTML = "2";
  }, 2000)
  setTimeout(()=>{
    preLoader.innerHTML = "3";
  }, 3000)
  setTimeout(()=>{
...
var word = document.querySelector(".mainContainer h1");
...
let canPlaySoundSelector = (state=store.state) => isRunning(state) && soundEnabledSelector(state);
